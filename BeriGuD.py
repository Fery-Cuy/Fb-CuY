...
def loginSC():
	...
	if username =="Fery Gaming" and password =="Subscribe":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/FeryGaming')
				menu()
